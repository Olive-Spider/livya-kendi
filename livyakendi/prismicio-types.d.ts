...
interface BlogPostDocumentData {
  ...
  /**
   * Live Site field in *Blog Post*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: blog_post.live_site
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  live_site: prismic.LinkField;
...
interface SettingsDocumentData {
  ...
  /**
   * Gitlab Link field in *Settings*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.gitlab_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  gitlab_link: prismic.LinkField;
